...
from src.config import COINBASE_SYMBOL, COINBASE_WS_URL
...
class CoinbaseConnector(BaseConnector):
    async def run(self, queue: asyncio.Queue) -> None:
        ...
        # Coinbase rejects level2 without authentication, so use level2_batch.
        subscribe_message = {
            "type": "subscribe",
        ...
        while True:
            try:
                ...
                async with websockets.connect(
                    ...
                    logger.info("coinbase subscribed to level2_batch")
    ...
    def parse_message(self, msg: dict) -> MarketDataEvent | None:
        ...
        if msg_type == "snapshot":
            ...
            return MarketDataEvent(
                source="coinbase",
                symbol=msg.get("product_id", COINBASE_SYMBOL),
